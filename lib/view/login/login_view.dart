        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Stack(
              children: <Widget>[
                Positioned.fromRect(
                  rect: Rect.fromLTRB(0.0, 0.0, MediaQuery.of(context).size.width, MediaQuery.of(context).size.height * 0.8 - 20.0),
                  child: Container(
...
class CrossPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(size.width * 0.3, size.height * 0.3 + 0.5), Offset(size.width * leftLineFraction, size.height * leftLineFraction + 0.5), _paint);
    canvas.drawLine(Offset(size.width * 0.3, size.height * 0.3 - 1.5), Offset(size.width * leftLineFraction, size.height * leftLineFraction - 1.5), _paint2);
  }
